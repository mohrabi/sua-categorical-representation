...
monkey_dir = fullfile('J:\Data', selectivity, 'Zebel');
export_dir = fullfile('G:\Data', selectivity, 'Zebel');
% sessions = ls(fullfile(monkey_dir, '20*'));
% nsession = size(sessions, 1);
sessions = readmatrix('G:\Data\Fast\Zebel\mainSessions.csv', ...
    'OutputType', 'string', ...
    'NumHeaderLines', 1, ...
