...
root_good = fullfile('J:\Data', "Slow", "Zebel");
root_corr = fullfile('J:\Data', "Slow", "Zebel", 'Corrupted');
...
recordingInfo = readmatrix(fullfile('G:\Data', "Slow", "Zebel", "recordingInfo.xlsx"), ...
    'FileType', 'spreadsheet', ...
    'NumHeaderLines', 0, ...
    'OutputType', 'string');
if size(recordingInfo, 2) < 8
    recordingInfo(:, (size(recordingInfo, 2)+1):8) = missing;
...
writematrix(sessionInfo, 'G:\Data\Slow\Zebel\sessionInfo.csv');
...
sessionInfo = readmatrix('G:\Data\Slow\Zebel\sessionInfo.csv', ...
    'FileType', 'spreadsheet', ...
    'NumHeaderLines', 0, ...
    'OutputType', 'string');
...
for iRow = 1:size(info, 1)
    root = fullfile('G:\Data\Slow\Zebel', info(iRow, 1), 'Trial');
...
writematrix(itcNeuralInfo, 'G:\Data\Slow\Zebel\itcNeuralInfo.csv');
writematrix(pfcNeuralInfo, 'G:\Data\Slow\Zebel\pfcNeuralInfo.csv');

%%
figure_path = 'G:\Codes\Figures\psth\zebel-slow';
