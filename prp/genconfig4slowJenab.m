...
root_good = fullfile('J:\Data', "Slow", "Jenab");
root_corr = fullfile('J:\Data', "Slow", "Jenab", 'Corrupted');
...
recordingInfo = readmatrix(fullfile('G:\Data', "Slow", "Jenab", "recordingInfo.xlsx"), ...
...
writematrix(sessionInfo, 'G:\Data\Slow\Jenab\sessionInfo.csv');
...
sessionInfo = readmatrix('G:\Data\Slow\Jenab\sessionInfo.csv', ...
    'FileType', 'spreadsheet', ...
    'NumHeaderLines', 0, ...
    'OutputType', 'string');
...
for iRow = 1:size(info, 1)
    root = fullfile('G:\Data\Slow\Jenab', info(iRow, 1), 'Trial');
...
writematrix(itcNeuralInfo, 'G:\Data\Slow\Jenab\itcNeuralInfo.csv');
writematrix(pfcNeuralInfo, 'G:\Data\Slow\Jenab\pfcNeuralInfo.csv');

%%
figure_path = 'G:\Codes\Figures\psth\jenab-slow';
